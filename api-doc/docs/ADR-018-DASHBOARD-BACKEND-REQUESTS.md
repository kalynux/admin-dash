...
[`docs/dashboard/backend-requests/`](../admin/dashboard/backend-requests/). Each states the ask, quotes
...
[`docs/dashboard/backend-requests/RESPONSE-2026-08-17.md`](../admin/dashboard/backend-requests/RESPONSE-2026-08-17.md),
...
[`DATA-EXPOSURE-REGISTER.md` §1](../admin/dashboard/DATA-EXPOSURE-REGISTER.md), "a person's coordinates,
