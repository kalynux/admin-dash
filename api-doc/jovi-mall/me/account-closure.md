...
> ADR-A02 (not mirrored here — `backend/jovi-mall/docs/ADR-A02-ACCOUNT-CLOSURE.md`).
>
...
(see auth/customer-auth.md (not mirrored here — `backend/jovi-mall/api-doc/auth/customer-auth.md`)) — so a password prompt would make
...
`geo-tracker/docs/ADR-B02-CLOSED-ACCOUNT-TRAIL.md` (not mirrored here — `backend/geo-tracker/docs/ADR-B02-CLOSED-ACCOUNT-TRAIL.md`)
...
- auth/customer-auth.md (not mirrored here — `backend/jovi-mall/api-doc/auth/customer-auth.md`) — why customers are passwordless
- customer/profile.md (not mirrored here — `backend/jovi-mall/api-doc/customer/profile.md`) — the profile this anonymises
