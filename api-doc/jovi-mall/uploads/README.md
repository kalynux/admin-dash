...
PROPOSAL-file-url-on-read.md (not mirrored here — `backend/jovi-mall/api-doc/uploads/PROPOSAL-file-url-on-read.md`); two malformed JSON examples were
...
Plan caps by role and tier: ../billing-plans-across-roles.md (not mirrored here — `backend/jovi-mall/api-doc/billing-plans-across-roles.md`).
...
- **`quota_blocked` is reversible and lossless.** The row, the bytes, and the file's contribution to
  ...
  ../FRONTEND-CHANGELOG-plan-quota.md (not mirrored here — `backend/jovi-mall/api-doc/FRONTEND-CHANGELOG-plan-quota.md`).
...
## Related
- PROPOSAL-file-url-on-read.md (not mirrored here — `backend/jovi-mall/api-doc/uploads/PROPOSAL-file-url-on-read.md`) — why the four endpoints gained
...
- [../errors/README.md](../errors/README.md) · ../billing-plans-across-roles.md (not mirrored here — `backend/jovi-mall/api-doc/billing-plans-across-roles.md`)
