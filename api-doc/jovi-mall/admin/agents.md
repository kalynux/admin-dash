...
> admin/agency-written). See ../agent/agency-membership.md (not mirrored here — `backend/jovi-mall/api-doc/agent/agency-membership.md`) and
...
> `AgentMembershipDto` (not mirrored here — `backend/jovi-mall/api-doc/agency/agent-roster.md`) as the detail read's
> `memberships[]`.
...
agency/agent-roster.md (not mirrored here — `backend/jovi-mall/api-doc/agency/agent-roster.md`). **Unpaginated by design**: an
...
> contract. See agency/agent-roster.md (not mirrored here — `backend/jovi-mall/api-doc/agency/agent-roster.md`).
...
- ../agency/agent-roster.md (not mirrored here — `backend/jovi-mall/api-doc/agency/agent-roster.md`) — agency-side roster management
- ../agent/agency-membership.md (not mirrored here — `backend/jovi-mall/api-doc/agent/agency-membership.md`) · ../agent/availability-and-device.md (not mirrored here — `backend/jovi-mall/api-doc/agent/availability-and-device.md`)
- [../tracking/agent-tracking-policy.md](../tracking/agent-tracking-policy.md)
...
> on the **agency** side (../agency/agent-roster.md (not mirrored here — `backend/jovi-mall/api-doc/agency/agent-roster.md`)). Still outstanding:
