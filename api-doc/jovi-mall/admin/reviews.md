...
> ../reviews.md (not mirrored here — `backend/jovi-mall/api-doc/reviews.md`). This page is the moderation surface alone.
...
immediately.** The reasoning is in ../reviews.md § 3 (not mirrored here — `backend/jovi-mall/api-doc/reviews.md`);
