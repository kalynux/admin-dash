...
`vendor/earnings.md` § Requesting a payout (— not mirrored in this repository) and
`agency/earnings.md` § Requesting a payout (— not mirrored in this repository) for the
...
**`vendor/payout-methods.md`** (— not mirrored in this repository) · **`agency/payout-methods.md`** ·
**`agent/payout-methods.md`** payout methods — the three are the same schema, documented
per role.
