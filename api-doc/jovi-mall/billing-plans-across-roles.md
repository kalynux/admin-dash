...
| **Doc** | vendor/billing.md (not mirrored here — `backend/jovi-mall/api-doc/vendor/billing.md`) | agency/billing.md (not mirrored here — `backend/jovi-mall/api-doc/agency/billing.md`) | agent/billing.md (not mirrored here — `backend/jovi-mall/api-doc/agent/billing.md`) | [admin/billing.md](./admin/billing.md) |
...
`Cache-Control`. Contract: public/README.md (not mirrored here — `backend/jovi-mall/api-doc/public/README.md`).
...
documented once in vendor/billing.md (not mirrored here — `backend/jovi-mall/api-doc/vendor/billing.md`) and apply unchanged to
every role. Stripe specifics: vendor/stripe-payments.md (not mirrored here — `backend/jovi-mall/api-doc/vendor/stripe-payments.md`).
...
- Per-role notification docs: vendor (not mirrored here — `backend/jovi-mall/api-doc/vendor/notifications.md`) · agency (not mirrored here — `backend/jovi-mall/api-doc/agency/notifications.md`) · agent (not mirrored here — `backend/jovi-mall/api-doc/agent/notifications.md`).
