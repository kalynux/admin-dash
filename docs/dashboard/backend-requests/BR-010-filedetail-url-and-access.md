...
That pin is wrong in two ways, and [`files.md`](../../admin/api/files.md) repeats the first and
omits the second:
...
**2 · [`files.md`](../../admin/api/files.md)** — the field table under *"What a resolved file looks
...
[`support.md`](../../admin/api/support.md): that support attachments resolve publicly, and what
