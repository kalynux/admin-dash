...
[`docs/admin/`](../../admin/) is a **verbatim mirror** and read-only on this side, by design.
...
**Where:** [`docs/admin/api/errors.md`](../../admin/api/errors.md) versus
...
> — [`VERIFICATION-2026-08-24.md`](../../VERIFICATION-2026-08-24.md) § 1
...
**Where:** [`docs/admin/api/permissions.md`](../../admin/api/permissions.md) § *Composite guards*.
...
[`ROUTE-MAP.md`](../../ROUTE-MAP.md) shows the `+` on that row, and
[`MIGRATION-2026-08.md`](../../MIGRATION-2026-08.md) § 8 states *"15 routes are composite guards
