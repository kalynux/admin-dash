...
[`docs/admin/api/README.md`](../../admin/api/README.md) and
[ADR-005](../../admin/ADR-005-API-CONTRACT.md).
...
- **Every new error code must be added to [`errors.md`](../../admin/api/errors.md).** The dashboard's
