...
diff -r backend/admin/docs frontend/admin-dash/docs/admin      # only: dashboard/, error-codes.ts
diff -r backend/admin/docs/dashboard frontend/admin-dash/docs/dashboard   # silent
diff -r backend/geo-tracker/api-doc frontend/admin-dash/docs/geo-tracker  # banners only
```
