 ...
 * sidebar filtered on. Nothing here re-checks `users.read`; the screens inside
 * gate only what is narrower than the module, which is the two write actions and
 * the composite-guarded activity feed.
 *
 * `findNavTrail` resolves `/dashboard/users/:id` to the Users item by longest
    ...
    return (
        <Routes>
            ...
            {/*
              ...
              these paths — `users/*` already matched — and the gated element would
